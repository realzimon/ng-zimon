...
@NgModule({
  ...
  declarations: [ZiviListComponent, ZiviCardComponent, WhoDoesItStats, NumberFixedLen, PostlerComponent, PostStats],
  exports: [ZiviListComponent, WhoDoesItStats, PostlerComponent, PostStats],
  providers: []
})
